...
class SendMSGAPI
{
    ...
    function login($username, $password)
    {
        ...
        curl_setopt($this->curl, CURLOPT_URL, "http://site24.way2sms.com");
        ...
        curl_setopt($this->curl, CURLOPT_POSTFIELDS, "username=" . $uid . "&password=" . $pwd . "&Submit=Sign+in");
        ...
        curl_setopt($this->curl, CURLOPT_USERAGENT, 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.120 Safari/537.36');
...
?>
<?php 
	sendSMS("9804021941","DK9234998482","9804021941","hello");
?>
